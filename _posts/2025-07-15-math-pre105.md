...
## **Random Variable (RV)**
### **Definition** 
A **random variable $X$** is a function $X: \Omega \to \mathbb{R}$, $s \mapsto X(s)$ where $\Omega$ is the sample space---set of outcomes and $\mathbb{R}$ is the set of real numbers. 

For example, if we have a bag of marbles of different colors
...
A **random variable $X$** is a function $X: \Omega \to \mathbb{R}$ where $\Omega$ is a finite or countably infinite set.

For example, toss a coin three times in sequence



**Probability Mass Function (PMF)** <br>

**Probability Distribution Function (PMF)** <br>



### **Continuous RV - Probability**
A **random variable $X$** is a function $X: \Omega \to \mathbb{R}$ where $\Omega$ is an uncountabe set.
