...
<details class = "bordered-block">
    ...
    <div class = "bordered-inner-block language-python">
        ...
        <strong>Idea:</strong> Experiment different ways to form groups from the dataset, paraphrase them mathematically, and conclude which one may be best.
        <ol>
            <li> Group the . </li>
            <li> $(x_1, y_1)$ and $(x_2, y_2)$: two given data points. </li>
            <li> $x_3$: known coordinate of the third data point. </li>
        ...
        <table class = "language-python">
            <tr>
                ...
                <th>
                    Center of the group
                    $$C = \frac{Sum of values}{Number of values}$$
                </th>
                <th>
                    Radius of the group
                    $$R = \frac{Sum of distances from values to center}{Number of values}$$
                </th>
            </tr>
            <tr>
                <td rowspan="2">1</td>
        ...
        <figure style="margin-top: 0; ping-top: 0;">
            <iframe src="" title='Interactive GeoGebra applet showing Nearest Neighbor and Linear Interpolation.' frameborder='0' height="700px" width="100%" style="border: 1px solid #ddd; margin-top: 0; ping-top: 0;" allowfullscreen>Your browser does not support iframes. View the interactive applet <a href="https://www.geogebra.org/classic/mhxnhwws" target="_blank" rel="noopener">here</a>.</iframe>
