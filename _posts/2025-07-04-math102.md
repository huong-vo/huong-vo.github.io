...
In today's post, we'll explore matrices and cosine similarity. We'll also discuss some applications in AI including background substraction, traffic sign matching, and K-nearest neighbors. We won't learn every single details from Linear Algebra in this **Math for AI** series and course. Instead, we'll learn the basics and pick up more material along the way.

<https://colab.research.google.com/drive/1xaDm4PZTEfRqTtITaZJkPtF081oAkvjM?usp=sharing>

<hr>

All data can be transformed into vectors, so Linear Algebra can handle almost real-world information.
